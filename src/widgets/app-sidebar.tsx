...
export default function AppSidebar() {
	...
	return (
      ...
      <button onClick={() => setExpanded(!expanded)} className='flex items-center p-3 rounded-md hover:bg-[#b3adad4b] transition-colors mt-auto mb-2 mx-2'>
      <PanelLeftIcon size={20} /> {expanded && <span className='pl-5'>Свернуть</span>}
      </button>
		</nav>
	)
}
...
function NavItem({
	...
	return (
		<Link
			to={href}
			className={`flex items-center rounded-md hover:bg-[#b3adad4b]
