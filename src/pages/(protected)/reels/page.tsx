...
export default function ReelsPage() {
	...
	const [messangeDialog, setMessangeDialog] = React.useState<boolean>(false)
	const [openedCommentDialog, setOpenedCommentDialog] = React.useState<
		null | boolean
	>(false)
	const [likeReel] = useLikeReelMutation()

	if (isLoading) return <div className='w-[600px] ml-[50%] m-auto bg-green flex justify-center h-[60vh] items-center absolute top-0 right-[470px]'>Loading...</div>
