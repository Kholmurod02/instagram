...
export default function ReelsPage() {
	...
	return (
		<div className=' sm:w-[600px]  ml-[50%] sm:overflow-none overflow-hidden m-auto bg-green flex justify-center h-[100vh] sm:h-[100vh] items-center absolute top-0 right-[-100px] lg:right-[470px]'>
			<Carousel
				opts={{ align: 'start' }}
									...
									<CardContent className='relative w-full z-10 h-full'>
										<div className='w-full h-full flex justify-center'>
													...
													<div className='relative z-10'>
														...
														<div className='flex items-center space-x-3 text-white absolute bottom-[-50px] left-[70px] z-30'>
															...
															<div className='sm:block flex  items-center'>
																...
																<button
																onClick={() => {followUser(reel.userId),setFollow((prev)=>!prev)}}
											...
											<div className='absolute bottom-[-60px] sm:bottom-[-40px] z-10 right-[120px] lg:right-5 flex flex-col items-center space-y-4'>
												<div className='flex flex-col items-center'>
													<Heart
														className={`w-6 hover:text-[#ffffff4f] h-6 ${
															...
															onClick={() => {handleLikeClick(reel.postId),setLike((prev)=>!prev)}}
															/>
													<h1>{ like ? reel.postLikeCount+1:reel.postLikeCount}</h1>
												</div>
												<div className='flex flex-col items-center'>
													<MessageCircle
												...
												<div className='flex flex-col items-center'>
													<Ellipsis className='w-76h-76' onClick={()=>setEllips((prev)=>!prev)} />
												</div>
